...
public class Printer implements LabResource {
	 ...
	 */
	public Printer(String resourceId, int modelYear, boolean status, String supervisor, double cost){
	...
	/*
	 * This method set the status of printer instance to INACTIVE i.e. false.
	 */
	...
	/*
	 * This method returns the cost of maintenance/year of printer instance.
	 */
	...
	/*
	 * This method returns that the instance type is "Printer".
	 */
